...
![GitHub Workflow Status (branch)](https://img.shields.io/github/actions/workflow/status/AzimMuradov/mini-oracle/backend-ci.yml?branch=master&label=build%20%7C%20backend)
![GitHub Workflow Status (branch)](https://img.shields.io/github/actions/workflow/status/AzimMuradov/mini-oracle/frontend-streamlit-ci.yml?branch=master&label=build%20%7C%20streamlit%20frontend)
![GitHub Workflow Status (branch)](https://img.shields.io/github/actions/workflow/status/AzimMuradov/mini-oracle/frontend-telegram-bot-ci.yml?branch=master&label=build%20%7C%20telegram%20bot%20frontend)
